---
title: "List Website Events — GET /api/websites/{websiteId}/events"
sidebarTitle: "Get Events"
description: "Retrieve a paginated log of individual pageviews and custom events for a website, with full session context, newest first. Supports filtering and search."
---
