---
title: "Node.js API Client — @umami/api-client"
sidebarTitle: "API Client"
description: "Install and use the @umami/api-client TypeScript package to call every Betterumami API endpoint from Node.js with full type safety."
---
...
<Steps>
  ...
  <Step title="Configure environment variables">
    ...
    **Self-hosted instance**
    ...
    | `UMAMI_API_CLIENT_SECRET` | A random string used to generate unique tokens. Must match the `APP_SECRET` set in your Betterumami application. |
