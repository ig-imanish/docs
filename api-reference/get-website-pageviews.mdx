---
title: "Get Pageviews Over Time — GET /api/websites/{id}/pageviews"
sidebarTitle: "Get Pageviews"
description: "Fetch pageview and session counts grouped by a time interval for charting trends. Supports comparison periods, timezone-aware bucketing, and all filters."
---
