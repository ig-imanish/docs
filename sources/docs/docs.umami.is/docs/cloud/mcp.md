# Source: https://docs.umami.is/docs/cloud/mcp
...
## Connect[#](https://docs.umami.is/docs/cloud/mcp#connect)
...
Authenticate with an [API key](https://docs.umami.is/docs/cloud/api-key). Pass it in the `Authorization` header using the Bearer scheme:
...
## Client setup[#](https://docs.umami.is/docs/cloud/mcp#client-setup)
...
## Tools[#](https://docs.umami.is/docs/cloud/mcp#tools)
...
## Example prompts[#](https://docs.umami.is/docs/cloud/mcp#example-prompts)
...
## Revoking access[#](https://docs.umami.is/docs/cloud/mcp#revoking-access)

Access is tied to the API key. To disconnect an AI tool, delete the key under **Settings → API keys**.

[PreviousAPI Key](https://docs.umami.is/docs/cloud/api-key) [NextExport data](https://docs.umami.is/docs/cloud/export-data)
