# Source: https://docs.umami.is/docs/two-factor-authentication
...
## Requirements[#](https://docs.umami.is/docs/two-factor-authentication#requirements)
...
## Enabling 2FA for your account[#](https://docs.umami.is/docs/two-factor-authentication#enabling-2fa-for-your-account)

Click on the side nav profile button, then click **Settings**, then navigate to **Security**.

![image](https://docs.umami.is/images/docs/two-factor-settings.png)
...
![image](https://docs.umami.is/images/docs/two-factor-setup-qr.png)
...
![image](https://docs.umami.is/images/docs/two-factor-backup-codes.png)

## Logging in with 2FA[#](https://docs.umami.is/docs/two-factor-authentication#logging-in-with-2fa)
...
![image](https://docs.umami.is/images/docs/two-factor-login.png)

Five failed attempts will lock further attempts for 15 minutes.

## Disabling 2FA[#](https://docs.umami.is/docs/two-factor-authentication#disabling-2fa)
...
## Requiring 2FA[#](https://docs.umami.is/docs/two-factor-authentication#requiring-2fa)
...
![image](https://docs.umami.is/images/docs/two-factor-admin-security.png)
...
## Admin reset[#](https://docs.umami.is/docs/two-factor-authentication#admin-reset)
...
![image](https://docs.umami.is/images/docs/two-factor-admin-reset.png)

[PreviousEnable Redis](https://docs.umami.is/docs/enable-redis) [NextBypass ad blockers](https://docs.umami.is/docs/bypass-ad-blockers)
