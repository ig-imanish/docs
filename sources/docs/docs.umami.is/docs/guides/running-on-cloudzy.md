# Source: https://docs.umami.is/docs/guides/running-on-cloudzy
...
## Deploy Umami[#](https://docs.umami.is/docs/guides/running-on-cloudzy#deploy-umami)
...
## Open your Umami instance[#](https://docs.umami.is/docs/guides/running-on-cloudzy#open-your-umami-instance)
...
## Configure a production domain[#](https://docs.umami.is/docs/guides/running-on-cloudzy#configure-a-production-domain)
...
## Start collecting data[#](https://docs.umami.is/docs/guides/running-on-cloudzy#start-collecting-data)
...
## Manage the instance[#](https://docs.umami.is/docs/guides/running-on-cloudzy#manage-the-instance)
...
[PreviousRunning on CapRover](https://docs.umami.is/docs/guides/running-on-caprover) [NextRunning on DigitalOcean](https://docs.umami.is/docs/guides/running-on-digitalocean)
