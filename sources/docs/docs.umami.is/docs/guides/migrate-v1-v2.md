# Source: https://docs.umami.is/docs/guides/migrate-v1-v2
...
## Breaking changes[#](https://docs.umami.is/docs/guides/migrate-v1-v2#breaking-changes)

- The API endpoints have changed including new ones being added. See [API](https://docs.umami.is/docs/api) for more information.
...
- The tracker no longer uses CSS class names to trigger events. It now uses HTML data attributes. See [Track events](https://docs.umami.is/docs/track-events) for more information.
- The methods on the global `umami` JavaScript object have changed. There is now a single `.track()` method and a new way to send event data. See [Tracker functions](https://docs.umami.is/docs/tracker-functions) for more information.
- The `TRACKER_SCRIPT_NAME` environment variable no longer appends the `.js` extension to the script name. See [Environment variables](https://docs.umami.is/docs/environment-variables) for more information.

## Data migration[#](https://docs.umami.is/docs/guides/migrate-v1-v2#data-migration)
...
### Requirements[#](https://docs.umami.is/docs/guides/migrate-v1-v2#requirements)
...
## Running migration[#](https://docs.umami.is/docs/guides/migrate-v1-v2#running-migration)

There are two ways to run the migration script.

### Running inside the Umami folder[#](https://docs.umami.is/docs/guides/migrate-v1-v2#running-inside-the-umami-folder)
...
### Running standalone[#](https://docs.umami.is/docs/guides/migrate-v1-v2#running-standalone)
...
## Docker migration[#](https://docs.umami.is/docs/guides/migrate-v1-v2#docker-migration)
...
![image](https://docs.umami.is/images/docs/migrate-v1-v2.png)

[PreviousRunning on Vercel](https://docs.umami.is/docs/guides/running-on-vercel) [NextMigrate MySQL to PostgreSQL](https://docs.umami.is/docs/guides/migrate-mysql-postgresql)
