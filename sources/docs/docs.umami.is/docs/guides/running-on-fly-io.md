# Source: https://docs.umami.is/docs/guides/running-on-fly-io
...
## Setup using Umami's pre-built container[#](https://docs.umami.is/docs/guides/running-on-fly-io#setup-using-umamis-pre-built-container)
...
[PreviousRunning on DigitalOcean](https://docs.umami.is/docs/guides/running-on-digitalocean) [NextRunning on Forge](https://docs.umami.is/docs/guides/running-on-forge)
