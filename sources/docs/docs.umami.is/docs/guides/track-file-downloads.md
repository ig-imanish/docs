# Source: https://docs.umami.is/docs/guides/track-file-downloads
...
## Using data attributes[#](https://docs.umami.is/docs/guides/track-file-downloads#using-data-attributes)
...
## Tracking all downloads automatically[#](https://docs.umami.is/docs/guides/track-file-downloads#tracking-all-downloads-automatically)
...
## Viewing download data[#](https://docs.umami.is/docs/guides/track-file-downloads#viewing-download-data)
...
[PreviousTrack a single-page application](https://docs.umami.is/docs/guides/track-single-page-apps) [NextTrack form submissions](https://docs.umami.is/docs/guides/track-form-submissions)
