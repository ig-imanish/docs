# Source: https://docs.umami.is/docs/guides/migrate-mysql-postgresql
...
## Data migration[#](https://docs.umami.is/docs/guides/migrate-mysql-postgresql#data-migration)
...
## Requirements[#](https://docs.umami.is/docs/guides/migrate-mysql-postgresql#requirements)
...
## Install Umami with a PostgreSQL database[#](https://docs.umami.is/docs/guides/migrate-mysql-postgresql#install-umami-with-a-postgresql-database)

1. Install Umami (v2.19.0) on a PostgreSQL server. Documentation for the installation process can be found [here](https://docs.umami.is/docs/install).
...
## Running migration[#](https://docs.umami.is/docs/guides/migrate-mysql-postgresql#running-migration)

### MySQL dump file[#](https://docs.umami.is/docs/guides/migrate-mysql-postgresql#mysql-dump-file)
...
### Generating CSVs[#](https://docs.umami.is/docs/guides/migrate-mysql-postgresql#generating-csvs)
...
- The file path (/tmp/website\_event.csv) is on the MySQL server's filesystem, not necessarily your host.
...
[PreviousMigrate v1 to v2](https://docs.umami.is/docs/guides/migrate-v1-v2) [NextOverview](https://docs.umami.is/docs/api)
