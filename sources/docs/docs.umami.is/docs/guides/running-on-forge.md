# Source: https://docs.umami.is/docs/guides/running-on-forge
...
[Forge](https://forge.laravel.com/) is a paid server management service, tailored to hosting Laravel apps on Server Providers like DigitalOcean, Linode, Vultr, Amazon, Hetzner and more.

If you have a Forge Account and a connected server bucket, you can easily set up an Umami installation.

## Prerequisites[#](https://docs.umami.is/docs/guides/running-on-forge#prerequisites)
...
## Setup[#](https://docs.umami.is/docs/guides/running-on-forge#setup)
...
[PreviousRunning on Fly.io](https://docs.umami.is/docs/guides/running-on-fly-io) [NextRunning on Heroku](https://docs.umami.is/docs/guides/running-on-heroku)
