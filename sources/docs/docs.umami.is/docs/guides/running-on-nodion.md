# Source: https://docs.umami.is/docs/guides/running-on-nodion
...
## 1-Click Deploy Button[#](https://docs.umami.is/docs/guides/running-on-nodion#1-click-deploy-button)

[![Deploy](https://nodion-static.nodioncdn.com/nodion-button-m.svg)](https://my.nodion.com/applications/new?preset=umami)

### Setup Instructions[#](https://docs.umami.is/docs/guides/running-on-nodion#setup-instructions)
...
[PreviousRunning on Netlify](https://docs.umami.is/docs/guides/running-on-netlify) [NextRunning on Northflank](https://docs.umami.is/docs/guides/running-on-northflank)
