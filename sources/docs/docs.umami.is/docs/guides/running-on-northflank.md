# Source: https://docs.umami.is/docs/guides/running-on-northflank
...
## Setup Website and Database[#](https://docs.umami.is/docs/guides/running-on-northflank#setup-website-and-database)

### Northflank Button (Recommended)[#](https://docs.umami.is/docs/guides/running-on-northflank#northflank-button-recommended)
...
## Running on Northflank manually[#](https://docs.umami.is/docs/guides/running-on-northflank#running-on-northflank-manually)
...
[PreviousRunning on Nodion](https://docs.umami.is/docs/guides/running-on-nodion) [NextRunning on PlanetScale](https://docs.umami.is/docs/guides/running-on-planetscale)
