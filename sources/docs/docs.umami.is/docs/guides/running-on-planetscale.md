# Source: https://docs.umami.is/docs/guides/running-on-planetscale
...
## Setup[#](https://docs.umami.is/docs/guides/running-on-planetscale#setup)
...
If you are getting an error like the following example:
...
[PreviousRunning on Northflank](https://docs.umami.is/docs/guides/running-on-northflank) [NextRunning on Qovery](https://docs.umami.is/docs/guides/running-on-qovery)
