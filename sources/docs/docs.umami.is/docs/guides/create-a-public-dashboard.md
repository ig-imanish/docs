# Source: https://docs.umami.is/docs/guides/create-a-public-dashboard
...
## Option 1: Share a website's analytics[#](https://docs.umami.is/docs/guides/create-a-public-dashboard#option-1-share-a-websites-analytics)

The quickest way to share analytics publicly is with a share URL.

### Step 1: Create a share URL[#](https://docs.umami.is/docs/guides/create-a-public-dashboard#step-1-create-a-share-url)
...
### Step 2: Distribute the link[#](https://docs.umami.is/docs/guides/create-a-public-dashboard#step-2-distribute-the-link)
...
## Option 2: Share a custom board[#](https://docs.umami.is/docs/guides/create-a-public-dashboard#option-2-share-a-custom-board)

_Requires v3.1.0_

Boards let you build a custom dashboard with only the metrics and components that matter, then share it publicly.

### Step 1: Create a board[#](https://docs.umami.is/docs/guides/create-a-public-dashboard#step-1-create-a-board)
...
### Step 2: Design the board[#](https://docs.umami.is/docs/guides/create-a-public-dashboard#step-2-design-the-board)
...
### Step 3: Share the board[#](https://docs.umami.is/docs/guides/create-a-public-dashboard#step-3-share-the-board)
...
## Embedding in your website[#](https://docs.umami.is/docs/guides/create-a-public-dashboard#embedding-in-your-website)
...
[PreviousSet up team workspaces](https://docs.umami.is/docs/guides/setup-team-workspaces) [NextHosting](https://docs.umami.is/docs/guides/hosting)
