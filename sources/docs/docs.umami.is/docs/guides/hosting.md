# Source: https://docs.umami.is/docs/guides/hosting
...
## Single server[#](https://docs.umami.is/docs/guides/hosting#single-server)
...
## Separate database and web server[#](https://docs.umami.is/docs/guides/hosting#separate-database-and-web-server)
...
## App hosting[#](https://docs.umami.is/docs/guides/hosting#app-hosting)
...
## Managed databases[#](https://docs.umami.is/docs/guides/hosting#managed-databases)
...
[PreviousCreate a public dashboard](https://docs.umami.is/docs/guides/create-a-public-dashboard) [NextRunning on bunny.net](https://docs.umami.is/docs/guides/running-on-bunny)
