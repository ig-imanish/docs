# Source: https://docs.umami.is/docs/utm
...
## UTM parameters[#](https://docs.umami.is/docs/utm#utm-parameters)
...
## Create an insight[#](https://docs.umami.is/docs/utm#create-an-insight)

### Step 1: Run insight[#](https://docs.umami.is/docs/utm#step-1-run-insight)
...
![image](https://docs.umami.is/images/docs/utm-details.png)
...
[PreviousRetention](https://docs.umami.is/docs/retention) [NextRevenue](https://docs.umami.is/docs/revenue)
