# Source: https://docs.umami.is/docs/contributing
...
## Branching[#](https://docs.umami.is/docs/contributing#branching)
...
## Submitting a Pull Request[#](https://docs.umami.is/docs/contributing#submitting-a-pull-request)
...
## Reporting Issues[#](https://docs.umami.is/docs/contributing#reporting-issues)
...
## Development Setup[#](https://docs.umami.is/docs/contributing#development-setup)

See the [README](https://github.com/umami-software/umami/blob/master/README.md) for instructions on installing dependencies, configuring the database, and running Umami locally.

## License[#](https://docs.umami.is/docs/contributing#license)

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/umami-software/umami/blob/master/LICENSE).

[PreviousIntegrations](https://docs.umami.is/docs/integrations) [NextCode of Conduct](https://docs.umami.is/docs/code-of-conduct)
