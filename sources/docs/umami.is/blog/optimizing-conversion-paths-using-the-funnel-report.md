# Source: https://umami.is/blog/optimizing-conversion-paths-using-the-funnel-report

# Optimizing Conversion Paths Using the Funnel Report

August 15th, 2024Posted by Nick Andrews

![Optimizing Conversion Paths Using the Funnel Report](https://umami.is/images/blog/image-conversion-funnels.webp)
...
This section breaks down a few use cases for the Funnel report to get the ideas rolling. However, there are an infinite number of ways to use the Funnel report to uncover insights about your users and product. Use Case Example: Analyzing Sign-up to Activation Process
