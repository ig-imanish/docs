# Source: https://umami.is/blog/challenges-of-running-an-open-source-company

# Challenges of Running an Open Source Company

April 20th, 2024Posted by Mike Cao

![Challenges of Running an Open Source Company](https://umami.is/images/blog/image-open-source-business.webp)
...
Open source companies operate in a competitive market, where proprietary software companies, being around much longer, may have more resources to compete and retain market share. This is especially true if the open source company is trying to dethrone an incumbent proprietary software company. Therefore, open source companies must differentiate themselves by either offering a superior user experience, moving quickly with product development, or building an engaging community to help evangelize the software.

## Our Approach

At Umami, we are dedicated to open source development. Our main product, Umami Analytics, has its [source code](https://github.com/umami-software/umami) available for anyone to download, build and run, completely for free.

For monetization, we decided to adopt the SaaS (Software as a Service) model. We run a managed version of our application in the cloud, [Umami Cloud](https://cloud.umami.is?ref=umami-blog). The advantage of using the cloud service over self-hosting is that all maintenance, upgrades, data backups, and performance scaling are all handled by us.
...
**Dual-licensing** - Most of our products are liberally licensed under the [MIT](https://en.wikipedia.org/wiki/MIT_License) license so that they can be used as many people as possible so that they can then innovate further. We didn't want to limit the product in any way.
...
[Open source · Apr 15, 2025Why Umami is Open SourceDiscover what motivates us to be open source.](https://umami.is/blog/why-umami-is-open-source) [Open source · Jan 10, 2024Supporting multiple databases with Prisma ORMHow do we support multiple databases in one project?](https://umami.is/blog/supporting-multiple-databases-with-prisma-orm) [Product updates · Sep 16, 2026Umami v3.4Annotations, MCP support, account API keys, a typed API client, and session property filters for saved segments.](https://umami.is/blog/umami-v3.4)