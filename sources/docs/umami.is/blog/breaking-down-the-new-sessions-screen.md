# Source: https://umami.is/blog/breaking-down-the-new-sessions-screen

# Breaking down the new Sessions Screen

September 1st, 2024Posted by Nick Andrews

![Breaking down the new Sessions Screen](https://umami.is/images/blog/image-sessions.webp)
...
![image](https://umami.is/images/blog/sessions-screen.webp)
...
6. **Save Session Data**: We've introduced support for saving session data, opening up new user tracking and analysis possibilities. This feature works similarly to custom event data, allowing you to store and analyze more detailed user information. You can now use the identify function from the tracker script to save data about the current session; that data will appear in the new Properties tab.
...
Have questions about the new Sessions report or need help implementing session data saving? Don't hesitate to reach out to our support team at [support@umami.is](mailto:support@umami.is). We're here to help you get the most out of Umami!
