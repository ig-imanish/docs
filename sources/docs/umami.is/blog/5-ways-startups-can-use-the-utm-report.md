# Source: https://umami.is/blog/5-ways-startups-can-use-the-utm-report

# 5 Ways Startups Can Use the Umami UTM Report

November 4th, 2024Posted by Nick Andrews

![5 Ways Startups Can Use the Umami UTM Report](https://umami.is/images/blog/image-utm.webp)
...
Still have questions on the UTM report or UTM implementation best practices? For more information on how to make the most of the UTM report, don't hesitate to contact our support team at [support@umami.is](mailto:support@umami.is).

[Back](https://umami.is/blog)

## Keep reading

[Analytics guides · Sep 8, 2024Understanding UTM Link Performance with the UTM ReportYou can use the Umami UTM report if you’re using UTM parameters on your links.](https://umami.is/blog/understanding-utm-link-performance) [Growth · Sep 27, 2024Umami for Startup Performance MarketingFor Founder/ CEOs, effective performance marketing can be the difference between growth and stagnation.](https://umami.is/blog/umami-for-startup-performance-marketing) [Analytics guides · May 28, 2026Understanding HeatmapsSee where visitors click and scroll on your pages with Umami's new heatmaps feature.](https://umami.is/blog/understanding-heatmaps)