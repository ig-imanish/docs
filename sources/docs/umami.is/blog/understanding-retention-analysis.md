# Source: https://umami.is/blog/understanding-retention-analysis

# Understanding Retention Analysis

August 20th, 2024Posted by Nick Andrews

![Understanding Retention Analysis](https://umami.is/images/blog/image-retention.webp)
...
Like all Umami reports, the Retention report comes standard with all Umami plans. If you have any questions about using the Retention report or want to discuss how to get the most out of your Umami analytics suite, including how to combine insights from the Retention and Journey reports (or any other report for that matter), don't hesitate to reach out to our support team at [support@umami.is](mailto:support@umami.is).

[Back](https://umami.is/blog)

## Keep reading

[Analytics guides · May 28, 2026Understanding HeatmapsSee where visitors click and scroll on your pages with Umami's new heatmaps feature.](https://umami.is/blog/understanding-heatmaps) [Analytics guides · Jun 27, 2024How Umami Does Customer Journey AnalyticsUmami's Journey report maps the paths users take through your site or product. Here's how it works, and how to use it for onboarding, conversion, and feature adoption.](https://umami.is/blog/how-umami-does-customer-journey-analytics) [Analytics guides · Nov 6, 20245 Ways Startups Can Use the Umami Journey ReportThe Funnel report visualizes how users move through specific sequences of actions or pages on your website or product.](https://umami.is/blog/5-ways-startups-can-use-journey-report)