# Source: https://umami.is/blog/analytics-needs-at-different-startup-stages

# Analytics Needs at Different Startup Stages

September 22nd, 2024Posted by Nick Andrews

![Analytics Needs at Different Startup Stages](https://umami.is/images/blog/image-growth-stages.webp)
...
4. **Breakdown Report**: Get a quick overview of your visitors, views, and top pages. Use this to understand your overall user acquisition and engagement.
...
4. **Breakdown Report**: Utilize the advanced filtering options to segment your users based on various criteria (location, device, etc.), helping you understand different user types and their behaviors.
...
4. **Breakdown Report**: Filtering and segmentation capabilities can perform deep-dive analysis on specific user segments or behaviors.
...
- Documentation: [Breakdown Report Guide](https://umami.is/docs/reports/report-breakdown)
- Blog Post: [Understanding the Breakdown Report](https://umami.is/blog/understanding-the-insights-report)
...
- Blog Post: [Understanding UTM Link Performance](https://umami.is/blog/understanding-utm-link-performance)

#### Goals Report

- Documentation: [Goals Report Guide](https://umami.is/docs/reports/report-goals)
- Blog Posts:
 - [How to use the Goals Report to Drive Feature Usage, Adoption, and Conversions](https://umami.is/blog/how-to-use-the-goals-report)

#### Journey Report

- Documentation: [Journey Report Guide](https://umami.is/docs/reports/report-journey)
- Blog Post: [Perfect Your Understanding of User Journeys](https://umami.is/blog/how-umami-does-customer-journey-analytics)
...
Are you ready to get started with Umami? You can get started for free and run Umami alongside your existing analytics provider while you’re getting comfortable with it. For additional support, please reach out to our customer support team: [support@umami.is](mailto:support@umami.is)

[Back](https://umami.is/blog)

## Keep reading

[Growth · Sep 10, 2024Analytics for Startups - Why GA4 is not idealAnalytics aren’t usually designed for the unique needs and challenges of startups.](https://umami.is/blog/analytics-for-startups) [Growth · Oct 18, 2024How Startups Can Leverage Analytics for GrowthStartups who need to make quick decisions from their analytics.](https://umami.is/blog/how-startups-can-leverage-analytics-for-growth) [Growth · Sep 13, 2024The Lean Startup Approach to Website AnalyticsThe Lean Startup methodology, which can roughly be described as a Build-Measure-Learn-Adjust feedback loop.](https://umami.is/blog/the-lean-startup-approach-to-website-analytics)